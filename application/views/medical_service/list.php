        ...
        <div class="container">
            <div class="row">
                <div class="span12">
                    ...
                    <hr>
                    <a href="<?php echo base_url(); ?>medical_service/add" class="btn btn-small btn-primary"><i class="btn-icon-only icon-ok"></i>Add Medical Services</a>
                    <br><br>
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions"><a href="<?php echo base_url(); ?>medical_service/edit/<?= $medServ->medicalservice_id ?>" class="btn btn-small btn-primary"><i class="btn-icon-only icon-edit"> </i></a><a href="<?php echo base_url(); ?>medical_service/delete/<?= $medServ->medicalservice_id ?>" onclick="return confirm('Are you sure ?')" class="btn btn-danger btn-small"><i class="btn-icon-only icon-remove"> </i></a></td>
                            </tr>
                            <? } } ?>
                        </tbody>
                    </table>
